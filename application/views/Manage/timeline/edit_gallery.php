...
<section class="content">
  <?php echo $this->session->flashdata('response'); ?>
	...
	<div class="box-body">
		<form method="post" action="<?php echo site_url('adm/gallery/manage/edit/'.$tlrow->timeline_id.'/save'); ?>" role="form" enctype="multipart/form-data">
      ...
      <div class="box-header">
        ...
        <textarea name="description" class="form-control" required><?php echo $tlrow->timeline_details; ?></textarea>
      </div>
      <div class="clearfix">
      <!-- /.box-header -->
