		...
		<div class="theme-padding white-bg">
			<div class="container">
				...
				<div class="gallery style-2">
					<h2>3 Column gallery</h2>
					<div class="row">

						<!-- gallery Figure -->
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-01.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-01.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
							<div class="gallery-img-heading">
								<h5>team meeting ing ground</h5>
							</div>	
						</div>
						<!-- gallery Figure -->
						...
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-02.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-02.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
						...
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-03.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-03.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
						...
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-04.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-04.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
						...
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-05.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-05.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
						...
						<div class="col-sm-4 col-xs-6 r-full-width">
							<figure class="gallery-figure">
								<img src="images/gallery-v2/img-06.jpg" alt="">
								<figcaption class="overlay">
									<div class="position-center-center">
										<ul class="btn-list">
											<li><a class="fa fa-link" href="#"></a></li>
											<li><a href="images/gallery-v2/img-06.jpg" data-rel="prettyPhoto[gallery-v2]"><i class="fa fa-search"></i></a></li>
										</ul>
									</div>
								</figcaption>
							</figure>
